...
@section('content')
    <div class="row">
        <form id="form-add" action="{{ route('admin.categories.update', $categories['id']) }}" enctype="multipart/form-data" method="post" class="row" style="width: 100%">
            @csrf
            <div class="col-md-8">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" required id="hue-demo" class="form-control demo" data-control="hue" value="{{ $categories['name'] }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="custom-file">
                                        <input type="file" name="image" class="custom-file-input" id="validatedCustomFile" value="{{ asset($categories['image']) }}" required onchange="readURL(this);">
